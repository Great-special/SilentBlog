...
SECRET_KEY = 'django-insecure-os_ceijh30g3+ton2z_*&e#4o!g+*3fdp*$!5$m)v)*gje$h60'
...
CSRF_TRUSTED_ORIGINS = ['https://silentblog.up.railway.app']
...
STATICFILES_STORAGE_DIRS = 'whitenoise.storage.CompressedStaticFilesStorage'
